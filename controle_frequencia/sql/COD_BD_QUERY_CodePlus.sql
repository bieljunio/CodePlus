...
-- QUERY QUE VERIFICA EXISTÊNCIA DE REQUISIÇÃO DE RECUPERAÇÃO DE SENHA
SELECT COUNT(*)
	FROM LOG_ALTERACAO
		WHERE CPF_ALTERADO = '$S_cpf' --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
		AND CPF_RESPONSAVEL = '$S_cpf' --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
		AND REGISTRO_ANTIGO = 'REQUEST' --VALOR FIXO, NÃO ALTERAR
		AND TABELA = 'LOGIN' --VALOR FIXO, NÃO ALTERAR
		AND CAMPO = 'SENHA' --VALOR FIXO, NÃO ALTERAR
-- FIM QUERY

-- QUERY QUE INSERE NOVA REQUISIÇÃO DE RECUPERAÇÃO DE SENHA
INSERT INTO LOG_ALTERACAO
	VALUES
		('$TS_data_hora', --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
		 'LOGIN', --VALOR FIXO, NÃO ALTERAR
		 'SENHA', --VALOR FIXO, NÃO ALTERAR
		 'REQUEST', --VALOR FIXO, NÃO ALTERAR
		 '$S_cpf_alterado', --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
		 '$S_cpf_responsavel') --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
-- FIM QUERY

-- QUERY QUE ATUALIZA DATA DE REQUISIÇÃO
UPDATE LOG_ALTERACAO
	SET DATA_HORA = '$TS_data_hora' --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
		WHERE CPF_ALTERADO = '$S_cpf' --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
		AND CPF_RESPONSAVEL = '$S_cpf' --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
		AND REGISTRO_ANTIGO = 'REQUEST' --VALOR FIXO, NÃO ALTERAR
		AND TABELA = 'LOGIN' --VALOR FIXO, NÃO ALTERAR
...
-- QUERY QUE ATUALIZA REQUISIÇÃO
UPDATE LOG_ALTERACAO
	SET REGISTRO_ANTIGO = 'ALTERADO' --VALOR FIXO, NÃO ALTERAR
		WHERE CPF_ALTERADO = '$S_cpf' --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
		AND CPF_RESPONSAVEL = '$S_cpf' --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
		AND REGISTRO_ANTIGO = 'REQUEST' --VALOR FIXO, NÃO ALTERAR
		AND TABELA = 'LOGIN' --VALOR FIXO, NÃO ALTERAR
...
-- QUERY QUE SELECIONA FREQUÊNCIA EM DADO PERÍODO, BASEADO EM DADO CPF
-- ALTERAR $S_cpf POR CPF DE QUEM ESTÁ ACESSANDO FUNÇÃO
-- ALTERAR $DT_data_minima POR DATA MÍNIMA DO PERÍODO SELECIONADO
-- ALTERAR $DT_data_maxima POR DATA MÁXIMA DO PERÍODO SELECIONADO
SELECT DATA, ENTRADA, SAIDA
	FROM PONTO_FUNCIONARIO
		WHERE CPF = '$S_cpf' --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
		AND DATA BETWEEN '$DT_data_minima' --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
					AND '$DT_data_maxima' --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
-- FIM QUERY
----------------------------------------FIM------------------------------------------


----------------------------------------FUNCIONÁRIOS(EPIC): DADOS DE FREQUÊNCIA------
-- QUERY QUE SELECIONA FREQUÊNCIA EM DADO PERÍODO, BASEADO EM DADO CPF
-- ALTERAR $S_cpf POR CPF DE QUEM ESTÁ ACESSANDO FUNÇÃO
-- ALTERAR $DT_data_minima POR DATA MÍNIMA DO PERÍODO SELECIONADO
-- ALTERAR $DT_data_maxima POR DATA MÁXIMA DO PERÍODO SELECIONADO
...
-- QUERY QUE PEGA ID_CIDADE BASEADO EM NOME DA CIDADE
SELECT ID_CIDADE
	FROM CIDADE
		WHERE NOME = '$S_cidade'
-- FIM QUERY

-- QUERY QUE PEGA ID_VINCULO BASEADO EM NOME DO VINCULO
SELECT ID_VINCULO
	FROM VINCULO
		WHERE NOME = '$S_vinculo'
-- FIM QUERY

-- QUERY QUE PEGA ID_SETOR BASEADO EM NOME DO SETOR
SELECT ID_SETOR
	FROM SETOR
		WHERE NOME = '$S_setor'
-- FIM QUERY

-- QUERY QUE PEGA ID_CARGO BASEADO EM NOME DO CARGO
SELECT ID_CARGO
	FROM CARGO
		WHERE NOME = '$S_cargo'
-- FIM QUERY

-- QUERY QUE PEGA ID_ESTADO_CIVIL BASEADO EM NOME DO ESTADO_CIVIL
SELECT ID_ESTADO_CIVIL
	FROM ESTADO_CIVIL
		WHERE NOME = '$S_estado_civil'
-- FIM QUERY

-- QUERY QUE VERIFICA EXISTÊNCIA DE REQUISIÇÃO DE ALTERAÇÃO DE DADOS CADASTRAIS
SELECT COUNT(*)
	FROM LOG_ALTERACAO
		WHERE CPF_ALTERADO = '$S_cpf' --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
		AND CPF_RESPONSAVEL = '$S_cpf' --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
		AND REGISTRO_ANTIGO = 'REQUEST' --VALOR FIXO, NÃO ALTERAR
		AND TABELA = 'FUNCIONARIO' --VALOR FIXO, NÃO ALTERAR
		AND CAMPO = 'TODOS' --VALOR FIXO, NÃO ALTERAR
-- FIM QUERY

-- QUERY QUE INSERE NOVA REQUISIÇÃO DE ALTERAÇÃO DE DADOS CADASTRAIS
INSERT INTO LOG_ATERACAO
	VALUES
		('$TS_data_hora', --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
		 'FUNCIONARIO', --VALOR FIXO, NÃO ALTERAR
		 'TODOS', --VALOR FIXO, NÃO ALTERAR
		 'REQUEST', --VALOR FIXO, NÃO ALTERAR
		 '$S_cpf_alterado', --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
		 '$S_cpf_responsavel') --CUIDADO COM AS ASPAS, DEVEM SER MANTIDAS
-- FIM QUERY
