...
CREATE TABLE TEMP_LOG_FUNCIONARIO
(
    STATUS STATUS,
    CPF VARCHAR(12),
    RG VARCHAR(15),
    ...
    CONSTRAINT PK_T_FUNCIONARIO
    PRIMARY KEY(CPF),
    CONSTRAINT UK_T_FUNCIONARIO_RG
    UNIQUE (RG),
    CONSTRAINT UK_T_FUNCIONARIO_EMAIL
    UNIQUE (EMAIL),
    CONSTRAINT UK_T_FUNCIONARIO_RA
    UNIQUE(RA)
);
